...
public:
	...
	SimulateResiduals()
	{
        ...
        for (int i = 0; i < modelVario_.size(); i++) {
            modelVario_[i] = ModelVario();
        }
        
        modelVario_[0].Cn = 2.500000000000001;
        modelVario_[0].C1 = 4.520000000000002;
        modelVario_[0].a1 = 15;
        modelVario_[0].C2 = 6.780000000000003;
        modelVario_[0].a2 = 250;
        modelVario_[0].Type = "iso nest";

        modelVario_[1].Cn = 0.500000000000000;
        modelVario_[1].C1 = 1.400000000000000;
        modelVario_[1].a1 = 10;
        modelVario_[1].C2 = 2.600000000000001;
        modelVario_[1].a2 = 160;
        modelVario_[1].Type = "iso nest";

        modelVario_[2].Cn = 0.150000000000000;
        modelVario_[2].C1 = 0.420000000000000;
        modelVario_[2].a1 = 15;
        modelVario_[2].C2 = 0.630000000000000;
        modelVario_[2].a2 = 160;
        modelVario_[2].Type = "iso nest";

        modelVario_[3].Cn = 0.150000000000000;
        modelVario_[3].C1 = 0.225000000000000;
        modelVario_[3].a1 = 10;
        modelVario_[3].C2 = 0.225000000000000;
        modelVario_[3].a2 = 120;
        modelVario_[3].Type = "iso nest";

        modelVario_[4].Cn = 0.314321867136085;
        modelVario_[4].Type = "nug";

        modelVario_[5].Cn = 0.190749535511365;
        modelVario_[5].Type = "nug";

        modelVario_[6].Cn = 0.137846758971697;
        modelVario_[6].Type = "nug";

        modelVario_[7].Cn = 0.111283843493347;
        modelVario_[7].Type = "nug";

        modelVario_[8].Cn = 0.096499281204429;
        modelVario_[8].Type = "nug";

        modelVario_[9].Cn = 0.071736796680044;
        modelVario_[9].Type = "nug";

        modelVario_[10].Cn = 0.064816215163269;
        modelVario_[10].Type = "nug";

        modelVario_[11].Cn = 0.054076635653157;
        modelVario_[11].Type = "nug";

        modelVario_[12].Cn = 0.051188751201166;
        modelVario_[12].Type = "nug";

        modelVario_[13].Cn = 0.043316419835114;
        modelVario_[13].Type = "nug";

        modelVario_[14].Cn = 0.041398046055658;
        modelVario_[14].Type = "nug";

        modelVario_[15].Cn = 0.034663671578289;
        modelVario_[15].Type = "nug";

        modelVario_[16].Cn = 0.018796994070527;
        modelVario_[16].Type = "nug";

        modelVario_[17].Cn = 0.002856941187582;
        modelVario_[17].Type = "nug";

        modelVario_[18].Cn = 3.606453961200486e-04;
        modelVario_[18].Type = "nug";
    }
        ...
        //注册场地, 乔斯基分解
    {
        ...
        for (int i = 0; i < nPCs; i++)
        {
            ...
            if (cholSolver.info() == Eigen::Success) {
                ...
                cout << "Cholesky decomposition of covariance matrix failed!" << endl;
                // Use eigen solver
